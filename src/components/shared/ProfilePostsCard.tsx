...
const ProfilePostsCard = ({post}:PostCardProps) => {

  const {user} = useUserContext()
  return (
    <div className='w-full  pt-5  items-center flex flex-col'>

       <div className='post-card gap-3 flex flex-col'>
            ...
            {post?.imageUrl && (
                   ...
                   post.imageUrl.includes("/preview?") ? (
                        ...
                        <div className='flex items-center justify-center'>
                            <video controls className='max-h-[600px] rounded-[5px]  object-contain  '>
